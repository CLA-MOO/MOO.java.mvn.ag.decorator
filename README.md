...
### Probar 1 test
```
mvn -f app test -Dtest="AppTest#testEmailNotifier"
mvn -f app test -Dtest="AppTest#testEmailSMSNotifier"
mvn -f app test -Dtest="AppTest#testEmailSMSFacebookNotifier"
mvn -f app test -Dtest="AppTest#testEmailSMSFacebooMSTeamskNotifier"
```
### Ejecutar App
```
